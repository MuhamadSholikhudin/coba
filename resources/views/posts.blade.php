  ...
  <div class="col-lg-6">
    <form action="/posts" method="GET">
      ...
      <div class="input-group mb-3">
        ...
        <button class="btn btn-outline-secondary btn-danger" type="submit" >search</button>
      </div>
    </form>
  </div>
</div>
...
<div class="card mb-3">
  ...
  <div style="max-height:400px; overflow:hidden;">
      <img src="{{ asset('storage')."/" . $posts[0]->image }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        ...
        @else
            <img src="https://source.unsplash.com/1200x400/?{{ $posts[0]->category->name }}" class="img-fluid mb-3" alt="{{ $posts[0]->category->name }}">
        @endif
  ...
  <div class="row">
    ...
    <div class="col-lg-4 mb-3">
      <div class="card" style="width: 18rem;">
        ...
        in <a href="/posts?categories={{ $post->category->slug }}" class="text-decoration-none"> {{ $post->category->name }} </a>
